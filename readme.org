...
#+name: Dino Itch Deploy
[[https://github.com/russmatney/dino/actions/workflows/dino_export_and_deploy.yml/badge.svg]]
...
You can play the release version here: [[https://russmatney.itch.io/dino][russmatney.itch.io/dino]]. I have a working
version available on Steam as well, and will setup sharing keys in the coming
weeks - ping me if you're interested!
...
** Fonts
*** V3X3D
The vexed fonts are not available for free distribution until they are
purchased! They can be purchased individually or as part of various bundles from
V3X3D's itch page: https://v3x3d.itch.io
