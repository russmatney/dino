...
Godot 4 port mostly complete! Not all games working again yet, but the latest
ones are fine.

--

NOTE: the recent hatbot/mvania game will not work out of the box b/c I'm not yet including
some game assets (fonts) in the repo.

--

A monorepo/sandbox with Godot games and addons.
...
* Credits
Hopefully in sync with ~src/credits/DinoCredits.gd~.
