...
var tries_max:int = 5
var pooling:int = 10
var grid_spawning:Vector2 = Vector2(0,0)
...
var r_grid_choice:String
var r_grid_x_variation:Vector3
var r_grid_y_variation:Vector3
...
#		},
		...
		{ name = "r_grid_choice", type = TYPE_STRING, usage = PROPERTY_USAGE_DEFAULT },
		{ name = "r_grid_x_variation", type = TYPE_VECTOR3, usage = PROPERTY_USAGE_DEFAULT },
		{ name = "r_grid_y_variation", type = TYPE_VECTOR3, usage = PROPERTY_USAGE_DEFAULT },
