...
var cf_dark_tile = preload("res://addons/bones/reptile/tilemaps/coldfire/ColdFireDark.tscn")
var cf_blue_tile = preload("res://addons/bones/reptile/tilemaps/coldfire/ColdFireBlue.tscn")
