...
func _on_rebuild_db_button_pressed():
	print(&"Rebuilding hotel db -----------------------------------")
	Hotel.recreate_db()
	list_entries()
	print(&"Rebuilt hotel db --------------------------------------")
...
const entry_label_scene = preload("res://addons/core/hotel/ui/EntryLabel.tscn")
...
const entry_detail_scene = preload("res://addons/core/hotel/ui/EntryDetail.tscn")
