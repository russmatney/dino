...
class BrickRoomOpts:
	...
	func _init(opts):
		...
		U.ensure_default(opts, "label_to_tilemap", {"Tile": {scene=load("res://addons/core/reptile/tilemaps/MetalTiles8.tscn")}})
...
static func add_tilemap(room: BrickRoom, opts: BrickRoomOpts, label: String, tmap_opts: Dictionary):
	var scene = tmap_opts.get("scene", load("res://addons/core/reptile/tilemaps/MetalTiles8.tscn"))
