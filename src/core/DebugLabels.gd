...
var label_scene = preload("res://src/core/DebugLabel.tscn")
...
const hotel_ui_scene = preload("res://src/core/hotel/ui/HotelUI.tscn")
var hotel_ui
...
const metro_map_scene = preload("res://src/core/metro/MetroMap.tscn")
var metro_map
